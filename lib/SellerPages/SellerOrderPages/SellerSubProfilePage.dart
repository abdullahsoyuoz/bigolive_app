...
class SellerSubProfilePage extends StatefulWidget {
  MainPageViewState mainPageViewState;
  FakeUser user;
  SellerSubProfilePage(this.user, {this.mainPageViewState});
  @override
  _SellerSubProfilePageState createState() => _SellerSubProfilePageState();
}

class _SellerSubProfilePageState extends State<SellerSubProfilePage> {
  @override
  void initState() {
    super.initState();
  }
